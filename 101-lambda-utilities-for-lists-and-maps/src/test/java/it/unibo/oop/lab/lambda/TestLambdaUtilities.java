...
final class TestLambdaUtilities {
    ...
    void testGroup() {
        ...
        assertEquals(
            ...
            LambdaUtilities.group(List.of("abc", "qwe", "zx", "o", "cv"), x -> x.length()) //NOPMD
        );
    }
    ...
    void testFill() {
        ...
        assertEquals(map.get("p1").intValue(), 1); //NOPMD
        assertEquals(map.get("p2").intValue(), 2); //NOPMD
        assertEquals(map.get("p3").intValue(), 3); //NOPMD
